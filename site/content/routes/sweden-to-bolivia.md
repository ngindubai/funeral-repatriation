---
title: "Bringing Someone Home from Sweden to Bolivia"
description: "Death in Sweden, coming home to Bolivia. Repatriation takes 2-3 weeks. Consular support included. Contact us 24/7."
origin_key: "sweden"
dest_key: "bolivia"
origin_name: "Sweden"
dest_name: "Bolivia"
...
date: 2026-07-05
direct_answer_heading: "Repatriation from Sweden to Bolivia: what to expect"
direct_answer_intro: "Repatriation from Sweden to Bolivia follows Sweden's civil registration and export procedures. Most cases take 2-3 weeks."
...
timeline_steps:
  ...
  - step: 6
    action: "Air cargo from Stockholm Arlanda (ARN), Gothenburg Landvetter (GOT), or other major Swedish airport to El Alto International Airport (LPB), La Paz, or Viru Viru International Airport (VVI), Santa Cruz."
...
faqs:
  - question: "How long does repatriation from Sweden to Bolivia take?"
    answer: "In a straightforward case, repatriation from Sweden to Bolivia takes 2-3 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 3-6 weeks."
  - question: "What documents are required for repatriation from Sweden to Bolivia?"
  ...
  - question: "What happens when the body arrives in Bolivia?"
    answer: "The Bolivian funeral director takes custody at the cargo terminal at El Alto International Airport (LPB) near La Paz or Viru Viru International Airport (VVI) near Santa Cruz, depending on where the receiving family and funeral home are based. Death is registered with SERECI (Servicio de Registro Civico), which sits under the Tribunal Supremo Electoral rather than a justice or health ministry. Bolivia is a Hague Apostille Convention member since 7 May 2018. Death certificates are issued in Spanish and must carry a QR code to be valid. All documentation from Sweden must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Sweden to Bolivia instead of repatriating the body?"
  ...
  - question: "Which city receives a repatriation from Sweden to Bolivia?"
