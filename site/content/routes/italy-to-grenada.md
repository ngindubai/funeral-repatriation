---
title: "Italy to Grenada: Funeral Repatriation Guidance"
description: "Arranging repatriation from Italy to Grenada? Most cases complete within 2-4 weeks. All documentation handled. Call us now."
origin_key: "italy"
dest_key: "grenada"
origin_name: "Italy"
dest_name: "Grenada"
...
date: 2026-07-09
direct_answer_heading: "Repatriation from Italy to Grenada: what to expect"
direct_answer_intro: "Repatriation from Italy to Grenada follows Italy's civil registration and export procedures. Most cases take 2-4 weeks."
...
timeline_steps:
  ...
  - step: 6
    action: "Air cargo from Rome Fiumicino (FCO), Milan Malpensa (MXP), Naples (NAP), or other major Italian airport to Maurice Bishop International Airport (GND), St George's."
...
faqs:
  - question: "How long does repatriation from Italy to Grenada take?"
    answer: "In a straightforward case, repatriation from Italy to Grenada takes 2-4 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 4-8 weeks."
  - question: "What documents are required for repatriation from Italy to Grenada?"
  ...
  - question: "What happens when the body arrives in Grenada?"
    answer: "The funeral director in Grenada takes custody at the cargo terminal at Maurice Bishop International Airport (GND), St George's. Death is registered with the Registrar General's Department at the Grenada Family Records Centre, under the Ministry of Health. Grenada has been a Hague Apostille Convention member since 7 April 2002. Death certificates are issued in English, typically within two days. All documentation from Italy must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Italy to Grenada instead of repatriating the body?"
  ...
  - question: "Where does cremation take place in Grenada if a family from Italy prefers it?"
