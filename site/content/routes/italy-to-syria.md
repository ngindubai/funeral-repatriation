---
title: "Italy to Syria: Funeral Repatriation Guidance"
description: "Death in Italy, coming home to Syria. Repatriation takes 2-4 weeks. Consular support, all documentation handled. Contact us 24/7."
origin_key: "italy"
dest_key: "syria"
origin_name: "Italy"
dest_name: "Syria"
...
date: 2026-06-26
direct_answer_heading: "Repatriation from Italy to Syria: what to expect"
direct_answer_intro: "Repatriation from Italy to Syria follows Italy's civil registration and export procedures. Most cases take 2-4 weeks."
...
dest_consular: "Syrian Embassy or Consulate in Italy: contact the Syrian authorities for documentation guidance. Note: the British Embassy in Damascus closed in March 2012. Syria is not a Hague Apostille member."
timeline_steps:
  - step: 1
  ...
  - step: 3
    action: "Embassy or consulate notified. Notify the Syrian Embassy or Consulate in Italy. FCDO 24-hour emergency line: +44 (0)20 7008 5000. Note: British Embassy Damascus closed March 2012."
  ...
  - step: 6
    action: "Air cargo from Rome Fiumicino (FCO), Milan Malpensa (MXP), Naples (NAP), or other major Italian airport to Damascus International Airport (DAM)."
...
faqs:
  - question: "How long does repatriation from Italy to Syria take?"
    answer: "In a straightforward case, repatriation from Italy to Syria takes 2-4 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 4-8 weeks."
  - question: "What documents are required for repatriation from Italy to Syria?"
  ...
  - question: "What happens when the body arrives in Syria?"
    answer: "The Syrian funeral director takes custody at the cargo terminal. Death is registered with the Civil Status Directorate. Documents are issued in Arabic. Syria is not a Hague Apostille Convention member; full consular authentication is required. The British Embassy in Damascus closed in March 2012. FCDO advises against all travel to Syria. A specialist repatriation company with Syria experience is essential. All documentation from Italy must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Italy to Syria instead of repatriating the body?"
