---
title: "Italy to Djibouti: Funeral Repatriation Guidance"
description: "Arranging repatriation from Italy to Djibouti? Most cases complete within 2-4 weeks. All documentation handled. Call us now."
origin_key: "italy"
dest_key: "djibouti"
origin_name: "Italy"
dest_name: "Djibouti"
...
date: 2026-07-08
direct_answer_heading: "Repatriation from Italy to Djibouti: what to expect"
direct_answer_intro: "Repatriation from Italy to Djibouti follows Italy's civil registration and export procedures. Most cases take 2-4 weeks."
...
timeline_steps:
  ...
  - step: 6
    action: "Air cargo from Rome Fiumicino (FCO), Milan Malpensa (MXP), Naples (NAP), or other major Italian airport to Djibouti-Ambouli International Airport (JIB)."
...
faqs:
  - question: "How long does repatriation from Italy to Djibouti take?"
    answer: "In a straightforward case, repatriation from Italy to Djibouti takes 2-4 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 4-8 weeks."
  - question: "What documents are required for repatriation from Italy to Djibouti?"
  ...
  - question: "What happens when the body arrives in Djibouti?"
    answer: "The funeral director in Djibouti takes custody at the cargo terminal at Djibouti-Ambouli International Airport (JIB). Death is registered through the etat civil; the Tribunal de Premiere Instance must issue an order for non-natural deaths before the Ministry of Health export permit can be granted. Djibouti is not a Hague Apostille Convention member; documents require legalisation. Documentation is issued in French and Arabic. All documentation from Italy must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Italy to Djibouti instead of repatriating the body?"
  ...
  - question: "Why is Djibouti's documentation different from most other Horn of Africa corridors for a family in Italy?"
