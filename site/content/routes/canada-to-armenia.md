---
title: "Canada to Armenia Repatriation: Family Guidance"
description: "A death in Canada brings immediate questions. Repatriation to Armenia takes 2-4 weeks. Contact us 24/7."
origin_key: "canada"
dest_key: "armenia"
origin_name: "Canada"
dest_name: "Armenia"
...
date: 2026-07-09
direct_answer_heading: "Repatriation from Canada to Armenia: what to expect"
direct_answer_intro: "Repatriation from Canada to Armenia follows Canada's civil registration and export procedures. Most cases take 2-4 weeks."
...
dest_consular: "Embassy of Armenia in Canada: contact the Armenian Embassy for documentation guidance. Hague Apostille applies (Armenia joined 1993). Certified translation into Armenian is required for foreign-language documentation."
timeline_steps:
  - step: 1
  ...
  - step: 3
    action: "Embassy or consulate notified. Notify the Embassy of Armenia in Canada. Hague Apostille applies (1993)."
  ...
  - step: 6
    action: "Air cargo from Toronto Pearson (YYZ), Vancouver (YVR), Montreal (YUL), or other major Canadian airport to Zvartnots International Airport (EVN), Yerevan."
...
faqs:
  - question: "How long does repatriation from Canada to Armenia take?"
    answer: "In a straightforward case, repatriation from Canada to Armenia takes 2-4 weeks. The fastest cases complete in 10-14 days. Complex cases involving criminal investigation or remote locations can take 4-8 weeks."
  - question: "What documents are required for repatriation from Canada to Armenia?"
  ...
  - question: "What happens when the body arrives in Armenia?"
    answer: "The Armenian funeral director takes custody at the cargo terminal at Zvartnots International Airport (EVN) near Yerevan. Death is registered with one of 52 Civil Status Acts Registration (CSAR) territorial bodies under the Ministry of Justice. In Yerevan, registration and certificates are handled through the Civic Status Registration Department at the municipal funeral bureau. Armenia is a Hague Apostille Convention member since 1993. Death certificates are issued in Armenian. All documentation from Canada must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Canada to Armenia instead of repatriating the body?"
