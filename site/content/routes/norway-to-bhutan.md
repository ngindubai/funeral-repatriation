---
title: "Bringing Someone Home from Norway to Bhutan"
description: "Death in Norway, coming home to Bhutan. Repatriation takes 2-3 weeks. Consular support included. Contact us 24/7."
origin_key: "norway"
dest_key: "bhutan"
origin_name: "Norway"
dest_name: "Bhutan"
...
date: 2026-07-07
direct_answer_heading: "Repatriation from Norway to Bhutan: what to expect"
direct_answer_intro: "Repatriation from Norway to Bhutan follows Norway's civil registration and export procedures. Most cases take 2-3 weeks."
...
timeline_steps:
  ...
  - step: 6
    action: "Air cargo from Oslo Gardermoen (OSL), Bergen (BGO), or Stavanger (SVG) to Paro International Airport (PBH), Bhutan's only international airport."
...
faqs:
  - question: "How long does repatriation from Norway to Bhutan take?"
    answer: "In a straightforward case, repatriation from Norway to Bhutan takes 2-3 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 3-6 weeks."
  - question: "What documents are required for repatriation from Norway to Bhutan?"
  ...
  - question: "What happens when the body arrives in Bhutan?"
    answer: "The funeral director in Bhutan takes custody after air cargo clears Paro International Airport (PBH), the country's only international gateway, where landings are restricted to daylight hours and a small number of specially certified pilots. Death is registered with the Department of Civil Registration and Census (DCRC), Ministry of Home and Cultural Affairs, through the Bhutan Civil Registration System. Bhutan is not a Hague Apostille Convention member; documents require legalisation through Bhutan's Ministry of Foreign Affairs instead. All documentation from Norway must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Norway to Bhutan instead of repatriating the body?"
  ...
  - question: "Are there any entry costs a family travelling from Norway to Bhutan should know about?"
