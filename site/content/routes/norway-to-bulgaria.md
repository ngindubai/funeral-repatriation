---
title: "Norway to Bulgaria: Funeral Repatriation Guidance"
description: "Death in Norway, coming home to Bulgaria. Repatriation takes 2-3 weeks. Consular support, all documentation handled. Contact us 24/7."
origin_key: "norway"
dest_key: "bulgaria"
origin_name: "Norway"
dest_name: "Bulgaria"
...
date: 2026-06-27
direct_answer_heading: "Repatriation from Norway to Bulgaria: what to expect"
direct_answer_intro: "Repatriation from Norway to Bulgaria follows Norway's civil registration and export procedures. Most cases take 2-3 weeks."
...
dest_consular: "Bulgarian Embassy in Norway: contact the Bulgarian Embassy for documentation guidance. Hague Apostille applies (Bulgaria joined 2001). Bulgaria is an EU member state. Certified translation into Bulgarian is required."
timeline_steps:
  - step: 1
  ...
  - step: 3
    action: "Embassy or consulate notified. Notify the Bulgarian Embassy in Norway. Hague Apostille applies (Bulgaria joined 2001). Bulgaria is an EU member state. Certified translation into Bulgarian is required."
  ...
  - step: 6
    action: "Air cargo from Oslo Gardermoen (OSL), Bergen (BGO), or Stavanger (SVG) to Sofia Airport (SOF), Varna International Airport (VAR), or Burgas Airport (BOJ)."
...
faqs:
  - question: "How long does repatriation from Norway to Bulgaria take?"
    answer: "In a straightforward case, repatriation from Norway to Bulgaria takes 2-3 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 3-6 weeks."
  - question: "What documents are required for repatriation from Norway to Bulgaria?"
  ...
  - question: "What happens when the body arrives in Bulgaria?"
    answer: "The Bulgarian funeral director takes custody at the cargo terminal at Sofia (SOF), Varna (VAR), or Burgas (BOJ). Death is registered with ESGRAON (civil registration system), administered by GRAO (Civil Registration and Administrative Services Directorate). Death certificates are issued in Bulgarian, which uses the Cyrillic script. Bulgaria is a Hague Apostille Convention member since 2001 and an EU member state. Certified translation into Bulgarian is required for all foreign-language documentation. All documentation from Norway must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Norway to Bulgaria instead of repatriating the body?"
  ...
  - question: "Do documents need to be translated into Bulgarian for repatriation from Norway to Bulgaria?"
    answer: "Yes. Bulgarian death certificates use the Cyrillic script and all official civil registration is conducted in Bulgarian. Documents from Norway require certified translation into Bulgarian before they are accepted by ESGRAON (the civil registration authority). Bulgaria is a Hague Apostille member since 2001, so Apostille-stamped documents from other Hague members are accepted. Your repatriation specialist will arrange certified translation as part of the documentation process."
links:
  upward:
