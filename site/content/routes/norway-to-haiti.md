---
title: "Norway to Haiti Repatriation Guide"
description: "When someone dies in Norway, Haiti families face a defined process taking 2-3 weeks. Contact us 24/7."
origin_key: "norway"
dest_key: "haiti"
origin_name: "Norway"
dest_name: "Haiti"
...
date: 2026-07-07
direct_answer_heading: "Repatriation from Norway to Haiti: what to expect"
direct_answer_intro: "Repatriation from Norway to Haiti follows Norway's civil registration and export procedures. Most cases take 2-3 weeks."
...
timeline_steps:
  ...
  - step: 6
    action: "Air cargo from Oslo Gardermoen (OSL), Bergen (BGO), or Stavanger (SVG) to Toussaint Louverture International Airport (PAP), Port-au-Prince, which has faced repeated security-related flight suspensions."
...
faqs:
  - question: "How long does repatriation from Norway to Haiti take?"
    answer: "In a straightforward case, repatriation from Norway to Haiti takes 2-3 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 3-6 weeks."
  - question: "What documents are required for repatriation from Norway to Haiti?"
  ...
  - question: "What happens when the body arrives in Haiti?"
    answer: "The funeral director in Haiti takes custody after air cargo clears Toussaint Louverture International Airport (PAP), Port-au-Prince, though the airport has faced repeated flight suspensions linked to unrest. Death is registered with the local bureau d'etat civil (civil registry office); records are forwarded to the National Archives of Haiti. Haiti is not a Hague Apostille Convention member; documents require consular legalisation. The death certificate, the acte de deces, is issued in French. All documentation from Norway must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Norway to Haiti instead of repatriating the body?"
  ...
  - question: "Does the current security situation in Haiti affect a repatriation from Norway?"
