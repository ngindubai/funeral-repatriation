---
title: "Bringing Someone Home from Canada to Niger"
description: "Death in Canada, coming home to Niger. Repatriation takes 2-4 weeks. Consular support included. Contact us 24/7."
origin_key: "canada"
dest_key: "niger"
origin_name: "Canada"
dest_name: "Niger"
...
date: 2026-07-10
direct_answer_heading: "Repatriation from Canada to Niger: what to expect"
direct_answer_intro: "Repatriation from Canada to Niger follows Canada's civil registration and export procedures. Most cases take 2-4 weeks."
...
timeline_steps:
  ...
  - step: 6
    action: "Air cargo from Toronto Pearson (YYZ), Vancouver (YVR), Montreal (YUL), or other major Canadian airport to Diori Hamani International Airport (NIM), Niamey."
...
faqs:
  - question: "How long does repatriation from Canada to Niger take?"
    answer: "In a straightforward case, repatriation from Canada to Niger takes 2-4 weeks. The fastest cases complete in 10-14 days. Complex cases involving criminal investigation or remote locations can take 4-8 weeks."
  - question: "What documents are required for repatriation from Canada to Niger?"
  ...
  - question: "What happens when the body arrives in Niger?"
    answer: "The funeral director in Niger takes custody at the cargo terminal at Diori Hamani International Airport (NIM), Niamey. Death is registered through local civil status offices, with police clearance issued through the Police Nationale. Niger is not a Hague Apostille Convention member; documents require consular legalisation. A military junta, the CNSP, has governed since the coup of July 2023. All documentation from Canada must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Canada to Niger instead of repatriating the body?"
  ...
  - question: "How has the 2023 coup in Niger changed repatriation logistics from Canada?"
