---
title: "Sweden to Benin Repatriation: Family Guidance"
description: "A death in Sweden brings immediate questions. Repatriation to Benin takes 2-3 weeks. Contact us 24/7."
origin_key: "sweden"
dest_key: "benin"
origin_name: "Sweden"
dest_name: "Benin"
...
date: 2026-07-10
direct_answer_heading: "Repatriation from Sweden to Benin: what to expect"
direct_answer_intro: "Repatriation from Sweden to Benin follows Sweden's civil registration and export procedures. Most cases take 2-3 weeks."
...
timeline_steps:
  ...
  - step: 6
    action: "Air cargo from Stockholm Arlanda (ARN), Gothenburg Landvetter (GOT), or other major Swedish airport to Cadjehoun Airport (COO), Cotonou."
...
faqs:
  - question: "How long does repatriation from Sweden to Benin take?"
    answer: "In a straightforward case, repatriation from Sweden to Benin takes 2-3 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 3-6 weeks."
  - question: "What documents are required for repatriation from Sweden to Benin?"
  ...
  - question: "What happens when the body arrives in Benin?"
    answer: "The funeral director in Benin takes custody at the cargo terminal at Cadjehoun Airport (COO), Cotonou. Death is registered at the Tribunal de Premiere Instance, and Parquet clearance is required before remains can be exported. Benin is not a Hague Apostille Convention member; documents require legalisation. Documentation is issued in French. All documentation from Sweden must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Sweden to Benin instead of repatriating the body?"
  ...
  - question: "Why does the Burkina Faso border matter for a repatriation from Sweden to Benin?"
