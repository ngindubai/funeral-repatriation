---
title: "Belgium to Tuvalu Repatriation: Family Guidance"
description: "A death in Belgium brings immediate questions. Repatriation to Tuvalu takes 2-4 weeks. Contact us 24/7."
origin_key: "belgium"
dest_key: "tuvalu"
origin_name: "Belgium"
dest_name: "Tuvalu"
...
date: 2026-07-10
direct_answer_heading: "Repatriation from Belgium to Tuvalu: what to expect"
direct_answer_intro: "Repatriation from Belgium to Tuvalu follows Belgium's civil registration and export procedures. Most cases take 2-4 weeks."
...
timeline_steps:
  ...
  - step: 6
    action: "Air cargo from Brussels Airport (BRU) or Brussels South Charleroi (CRL) to Funafuti International Airport (FUN)."
...
faqs:
  - question: "How long does repatriation from Belgium to Tuvalu take?"
    answer: "In a straightforward case, repatriation from Belgium to Tuvalu takes 2-4 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 4-8 weeks."
  - question: "What documents are required for repatriation from Belgium to Tuvalu?"
  ...
  - question: "What happens when the body arrives in Tuvalu?"
    answer: "The funeral director in Tuvalu takes custody at the cargo terminal at Funafuti International Airport (FUN). Fiji Airways is the only international carrier, so all onward connections route through Nadi or Suva before continuing to Sydney, Singapore, or Hong Kong. Death registration goes through the Tuvalu Births, Deaths and Marriages Registry, with the Tuvalu Police Service investigating non-natural deaths. Tuvalu is not a Hague Apostille Convention member; documents require standard legalisation. A death on any of the eight outer atolls depends on the government vessel MV Nivaga III for transfer to Funafuti, a service that runs infrequently and is weather-dependent. Cremation is not available; full body repatriation is required. All documentation from Belgium must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Belgium to Tuvalu instead of repatriating the body?"
  ...
  - question: "How does the MV Nivaga III affect a repatriation from Belgium to Tuvalu?"
