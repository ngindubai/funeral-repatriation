---
title: "Norway to Turkmenistan Repatriation Guide"
description: "When someone dies in Norway, Turkmenistan families face a defined process taking 2-3 weeks. Contact us 24/7."
origin_key: "norway"
...
date: 2026-07-09
direct_answer_heading: "Repatriation from Norway to Turkmenistan: what to expect"
direct_answer_intro: "Repatriation from Norway to Turkmenistan follows Norway's civil registration and export procedures. Most cases take 2-3 weeks."
...
timeline_steps:
  ...
  - step: 6
    action: "Air cargo from Oslo Gardermoen (OSL), Bergen (BGO), or Stavanger (SVG) to Ashgabat International Airport (ASB), Turkmenistan's sole international gateway."
...
faqs:
  - question: "How long does repatriation from Norway to Turkmenistan take?"
    answer: "In a straightforward case, repatriation from Norway to Turkmenistan takes 2-3 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 3-6 weeks."
  - question: "What documents are required for repatriation from Norway to Turkmenistan?"
  ...
  - question: "What happens when the body arrives in Turkmenistan?"
    answer: "The funeral director in Turkmenistan takes custody at the cargo terminal at Ashgabat International Airport (ASB). Death is registered with the Civil Registry Office (ZAGS), a Soviet-model system, and the Ministry of Internal Affairs issues the export permit. Turkmenistan is not a Hague Apostille Convention member; documents require legalisation. Documentation is issued in Turkmen and Russian. All documentation from Norway must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Norway to Turkmenistan instead of repatriating the body?"
  ...
  - question: "Why does Turkmenistan's closed governance environment matter for a repatriation from Norway?"
