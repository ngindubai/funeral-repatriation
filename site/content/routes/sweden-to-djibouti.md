---
title: "Sweden to Djibouti Repatriation Guide"
description: "When someone dies in Sweden, Djibouti families face a defined process taking 2-3 weeks. Contact us 24/7."
origin_key: "sweden"
dest_key: "djibouti"
origin_name: "Sweden"
dest_name: "Djibouti"
...
date: 2026-07-10
direct_answer_heading: "Repatriation from Sweden to Djibouti: what to expect"
direct_answer_intro: "Repatriation from Sweden to Djibouti follows Sweden's civil registration and export procedures. Most cases take 2-3 weeks."
...
timeline_steps:
  ...
  - step: 6
    action: "Air cargo from Stockholm Arlanda (ARN), Gothenburg Landvetter (GOT), or other major Swedish airport to Djibouti-Ambouli International Airport (JIB)."
...
faqs:
  - question: "How long does repatriation from Sweden to Djibouti take?"
    answer: "In a straightforward case, repatriation from Sweden to Djibouti takes 2-3 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 3-6 weeks."
  - question: "What documents are required for repatriation from Sweden to Djibouti?"
  ...
  - question: "What happens when the body arrives in Djibouti?"
    answer: "The funeral director in Djibouti takes custody at the cargo terminal at Djibouti-Ambouli International Airport (JIB). Death is registered through the etat civil; the Tribunal de Premiere Instance must issue an order for non-natural deaths before the Ministry of Health export permit can be granted. Djibouti is not a Hague Apostille Convention member; documents require legalisation. Documentation is issued in French and Arabic. All documentation from Sweden must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Sweden to Djibouti instead of repatriating the body?"
  ...
  - question: "Why is Djibouti's documentation different from most other Horn of Africa corridors for a family in Sweden?"
