---
title: "Bringing Someone Home from France to Tonga"
description: "Death in France, coming home to Tonga. Repatriation takes 2-4 weeks. Consular support included. Contact us 24/7."
origin_key: "france"
dest_key: "tonga"
origin_name: "France"
dest_name: "Tonga"
...
date: 2026-07-10
direct_answer_heading: "Repatriation from France to Tonga: what to expect"
direct_answer_intro: "Repatriation from France to Tonga follows France's civil registration and export procedures. Most cases take 2-4 weeks."
...
timeline_steps:
  ...
  - step: 6
    action: "Air cargo from Paris Charles de Gaulle (CDG), Paris Orly (ORY), Lyon Saint-Exupery (LYS), or other major French airport to Fua'amotu International Airport (TBU), Tongatapu."
...
faqs:
  - question: "How long does repatriation from France to Tonga take?"
    answer: "In a straightforward case, repatriation from France to Tonga takes 2-4 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 4-8 weeks."
  - question: "What documents are required for repatriation from France to Tonga?"
  ...
  - question: "What happens when the body arrives in Tonga?"
    answer: "The funeral director in Tonga takes custody at the cargo terminal at Fua'amotu International Airport (TBU), Tongatapu. Death is registered with the Registrar General's Office, with a post-mortem from Vaiola Hospital where required, before the Ministry of Health issues the export permit. Tonga has been a Hague Apostille Convention member since 4 June 1970 (succession). Documentation is processed in English. Deaths in the Vava'u or Ha'apai groups need inter-island transfer first, and Vaiola Hospital has no hyperbaric decompression capacity, so diving-related incidents require medical evacuation before a repatriation case can begin. All documentation from France must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from France to Tonga instead of repatriating the body?"
  ...
  - question: "What happens if a death in Tonga involves diving or the Vava'u whale season, for a family in France?"
