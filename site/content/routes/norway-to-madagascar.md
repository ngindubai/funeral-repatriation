---
title: "Repatriation from Norway to Madagascar"
description: "Bringing a loved one home from Norway to Madagascar takes 2-3 weeks in most cases. All documentation handled. Contact us 24/7."
origin_key: "norway"
dest_key: "madagascar"
origin_name: "Norway"
...
date: 2026-07-07
direct_answer_heading: "Repatriation from Norway to Madagascar: what to expect"
direct_answer_intro: "Repatriation from Norway to Madagascar follows Norway's civil registration and export procedures. Most cases take 2-3 weeks."
...
timeline_steps:
  ...
  - step: 6
    action: "Air cargo from Oslo Gardermoen (OSL), Bergen (BGO), or Stavanger (SVG) to Ivato International Airport (TNR), Antananarivo."
...
faqs:
  - question: "How long does repatriation from Norway to Madagascar take?"
    answer: "In a straightforward case, repatriation from Norway to Madagascar takes 2-3 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 3-6 weeks."
  - question: "What documents are required for repatriation from Norway to Madagascar?"
  ...
  - question: "What happens when the body arrives in Madagascar?"
    answer: "The funeral director in Madagascar takes custody at the cargo terminal at Ivato International Airport (TNR), Antananarivo. Death is registered with the local commune's civil status officer, within 30 days, under Madagascar's 2018 civil registration law. Madagascar is not a Hague Apostille Convention member; documents require consular legalisation. The death certificate, the acte de deces, is issued in French. All documentation from Norway must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from Norway to Madagascar instead of repatriating the body?"
  ...
  - question: "Why does Madagascar's Apostille status matter for a repatriation from Norway?"
