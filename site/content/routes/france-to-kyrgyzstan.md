---
title: "France to Kyrgyzstan Repatriation Guide"
description: "When someone dies in France, Kyrgyzstan families face a defined process taking 2-4 weeks. Contact us 24/7."
origin_key: "france"
dest_key: "kyrgyzstan"
origin_name: "France"
...
date: 2026-07-09
direct_answer_heading: "Repatriation from France to Kyrgyzstan: what to expect"
direct_answer_intro: "Repatriation from France to Kyrgyzstan follows France's civil registration and export procedures. Most cases take 2-4 weeks."
...
dest_consular: "Embassy of Kyrgyzstan in France: contact the Kyrgyzstani Embassy for documentation guidance. Hague Apostille applies (Kyrgyzstan joined 2011). Certified translation may be required depending on the destination language."
timeline_steps:
  - step: 1
  ...
  - step: 3
    action: "Embassy or consulate notified. Notify the Embassy of Kyrgyzstan in France. Hague Apostille applies (2011)."
  ...
  - step: 6
    action: "Air cargo from Paris Charles de Gaulle (CDG), Paris Orly (ORY), Lyon Saint-Exupery (LYS), or other major French airport to Manas International Airport (FRU), Bishkek."
...
faqs:
  - question: "How long does repatriation from France to Kyrgyzstan take?"
    answer: "In a straightforward case, repatriation from France to Kyrgyzstan takes 2-4 weeks. The fastest cases complete in 7-14 days. Complex cases involving criminal investigation or remote locations can take 4-8 weeks."
  - question: "What documents are required for repatriation from France to Kyrgyzstan?"
  ...
  - question: "What happens when the body arrives in Kyrgyzstan?"
    answer: "The Kyrgyzstani funeral director takes custody at the cargo terminal at Manas International Airport (FRU) near Bishkek. Death is registered with the local civil registry office (civil status acts registration). Kyrgyzstan is a Hague Apostille Convention member since 31 July 2011. Death certificates are issued in Kyrgyz and Russian. All documentation from France must be in order before the body is released for the funeral."
  - question: "Can I bring ashes home from France to Kyrgyzstan instead of repatriating the body?"
  ...
  - question: "What is the realistic timeline for repatriation from France to Kyrgyzstan?"
