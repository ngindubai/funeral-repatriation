...
faqs:
  - question: "What should be itemised in a repatriation quote?"
    answer: "A good quote itemises: local funeral director fees (preparation, embalming, casket, documentation, handling), translation and notarisation costs, consular fees, ground transport, airline cargo (with the airline named), UK airport receiving charges, and UK funeral director reception fees. A single total figure with no breakdown should be challenged."
  - question: "How many quotes should I get?"
    answer: "At least two, ideally three. Quote comparison reveals significant variation and helps you identify outliers. Be cautious of quotes that are significantly cheaper than others without a clear explanation -- they often involve unknown local subcontractors with reduced accountability."
  - question: "What are red flags in a repatriation quote?"
    answer: "Red flags include: no itemisation, vague references to 'all-inclusive' without detail, large 'documentation' or 'administration' line items without explanation, no named local funeral director, promises of timelines significantly faster than industry norms for that country, and reluctance to put commitments in writing."
  - question: "How quickly should a provider give me a quote?"
    answer: "For an initial estimate based on country and case type, within a few hours of first contact. For a detailed itemised quote, within 24 to 48 hours. A provider taking longer than this without a clear reason is either overloaded or disorganised, both of which are concerns in a time-sensitive case."
  - question: "Should I always go with the cheapest quote?"
    answer: "No. The cheapest quote may involve a coordinator who subcontracts to an unknown local funeral director with no accountability. Quote evaluation should weight track record, country-specific experience, transparency of itemisation, and quality of communication alongside price. The cheapest is sometimes the worst value when problems emerge."
---
