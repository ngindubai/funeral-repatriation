...
faqs:
  - question: "How are human remains classified by airlines?"
    answer: "Under IATA Cargo regulations, human remains are classified with the code HUM (full body) or CRM (cremated remains). Each has specific handling, documentation, and acceptance requirements. The classification determines how the shipment is processed by the airline cargo team."
  - question: "How is air cargo cost calculated for human remains?"
    answer: "Cargo cost is calculated on chargeable weight (the greater of actual weight or dimensional weight) and the specific airline rate for the route. For HUM shipments, additional handling fees apply. Typical costs for HUM transport from Europe to the UK might be a few hundred pounds; long-haul costs from Asia or Australia can be GBP 1,500 to 4,000 just for the freight portion."
  - question: "Why is one airline more expensive than another on the same route?"
    answer: "Cargo capacity varies between carriers and aircraft. Some routes have dedicated freighter aircraft (lower cost per kg); others rely on belly cargo in passenger aircraft (higher cost per kg). Airline cargo divisions also set rates based on demand, route frequency, and their HUM handling capacity at both ends."
  - question: "Can a family book the cargo directly?"
    answer: "No. Airline cargo divisions only accept HUM shipments through licensed funeral directors or cargo agents with established accounts and the required IATA training. Direct family booking is not permitted because acceptance depends on certified container preparation, documentation review, and handling chain that funeral directors provide."
  - question: "Why might the cargo quote change between booking and shipping?"
    answer: "Cargo rates are not always fixed at quote stage. Fuel surcharges, capacity availability, and document readiness can affect the final price. A good coordinator will warn you of variables and try to lock in confirmation as early as possible."
---
