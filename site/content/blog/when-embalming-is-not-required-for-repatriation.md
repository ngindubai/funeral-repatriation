---
title: "When Embalming Is Not Required for Repatriation"
description: "When embalming can be avoided for repatriation, the refrigeration alternative, and which routes and religions allow it. Contact us 24/7."
date: 2026-06-03
slug: when-embalming-is-not-required-for-repatriation
author: "Claire Sutton"
author_title: "Bereavement and Repatriation Adviser, Repatriate Service"
category: "Process guides"
faqs:
  - question: "Is embalming always required for repatriation?"
    answer: "No, but it is required in most cases. The IATA regulations for the transport of human remains require that the body be preserved for the journey. Embalming is the most common method. Refrigeration is an alternative in specific circumstances, particularly for short transit times or where religious rules prohibit embalming. In practice, the airline, the country of departure, and the receiving country all have their own rules, and all must be satisfied."
  - question: "Can a Muslim body be repatriated without embalming?"
    answer: "Often yes. Most Muslim families prefer that embalming is avoided because it is considered contrary to Islamic teaching in the absence of legal necessity. Many airlines and receiving countries accept a sealed, refrigerated container as an alternative for Muslim remains. In practice, the repatriation coordinator negotiates this on the family's behalf with the airline and the local authorities. Some countries of origin will still require embalming regardless of religious preference."
  - question: "Is embalming required for road repatriation within Europe?"
    answer: "Road repatriation within the Schengen area operates under the Strasbourg Agreement (Council of Europe, 1973), which requires the body to be placed in a hermetically sealed zinc or equivalent liner, but does not always require embalming where transit time is short and the body is refrigerated throughout. Embalming is still commonly applied as a precaution. A repatriation coordinator will advise on the specific route."
  - question: "What is the alternative to embalming?"
    answer: "Refrigeration in a sealed zinc-lined or equivalent container is the principal alternative. The container must meet IATA Packing Instruction 650 standards for human remains. Refrigerated storage and transport maintains the body without chemical preservation. This is more dependent on short transit times and continuous cold chain management, so it is more commonly used for European or regional routes than for long-haul flights."
  - question: "Does Sikh or Hindu tradition allow embalming?"
    answer: "Sikh and Hindu traditions do not prohibit embalming. Where embalming is legally required for the repatriation route, it is accepted in both traditions. Many Sikh and Hindu families choose cremation in the country of death and carry ashes home, which removes the question entirely."
---
