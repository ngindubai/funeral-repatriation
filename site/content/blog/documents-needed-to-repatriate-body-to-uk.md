...
short_answer: "To repatriate a body to the UK you need: the local death certificate (translated if not in English), an embalming certificate, a burial transit permit or export authorisation, the deceased's passport, and airline cargo documentation. Additional documents may include a police report, a post-mortem report, a consular death registration extract, and country-specific health clearances. The full list depends on the country of death."
---
