...
faqs:
  - question: "Do non-religious families have any requirements around repatriation?"
    answer: "No mandatory religious requirements, but all the legal requirements still apply. Embalming is required for most international transport routes. Documentation must be complete. The repatriation process is the same regardless of faith. The difference is that the family has complete freedom about the type of service, cremation vs burial, ceremony, and where the final resting place is."
  - question: "Is cremation abroad an option for non-religious families?"
    answer: "Yes, and it is often the simplest practical choice. Cremation in the country of death is typically faster and less expensive than body repatriation. Ashes can then be carried home on a passenger flight. There are no religious restrictions on this for non-religious families, so the decision is purely practical."
  - question: "Can a humanist funeral be arranged for someone who died abroad?"
    answer: "Yes. Humanist UK can connect families with a celebrant for a humanist funeral ceremony, either in the country of death (less common) or on return to the UK. Humanist ceremonies can take place at a crematorium, a venue of the family's choice, or outdoors. Contact Humanist UK to discuss options."
  - question: "What happens if there are no religious requirements but a post-mortem is needed?"
    answer: "The same as for any other death: if local law requires a post-mortem, it proceeds. Non-religious families are not exempt. The advantage is that non-religious families do not face the specific additional pressure of religious objections interacting with post-mortem requirements, which can simplify the practical handling somewhat."
  - question: "Where can ashes be scattered or kept for non-religious families?"
    answer: "In the UK, ashes can be scattered in many places with permission: at sea, in private land (owner's permission), or in some designated areas. No religious ceremony is required. Ashes can also be kept at home, or interred in a natural burial ground or memorial garden. Non-religious families have more flexibility over the final resting place than families bound by religious requirements."
---
