...
category: "Documents"
faqs:
  - question: "What documents does the British Embassy issue in a repatriation case?"
    answer: "The main documents are: the consular death registration (where the family chooses to register), the no objection letter (where required by the country of death for transport of remains), certified copies of the UK certificate (once registered), and notarial certifications in some cases."
  - question: "What is a no objection letter and when is it needed?"
    answer: "A no objection letter is a document from the British Embassy stating that the UK government has no objection to the transport of remains to the UK. Some countries (notably Saudi Arabia and some others) require this letter before they will release remains for international transport. The embassy issues it after confirming the deceased's identity and British nationality."
  - question: "Does the British Embassy issue a death certificate?"
    answer: "Not directly. The British Embassy can register the death (consular death registration) and forward the registration to the General Register Office in the UK. The GRO then issues the UK-format death certificate. The embassy itself does not issue the certificate, though it can issue certified copies once the GRO has registered the death."
  - question: "Can the British Embassy translate foreign documents?"
    answer: "No. The British Embassy does not provide translation services. Certified translation is a service provided by qualified translators or translation agencies. The embassy can sometimes provide a list of local English-speaking professionals including translators, but does not perform translation itself."
  - question: "Does the British Embassy provide the deceased's passport back to the family?"
    answer: "Yes, once the passport has served its purpose in identification. The passport is typically cancelled by the embassy (a corner clipped) and returned to the family as a memento. It is no longer a valid travel document but is returned because it is the family's property."
---
