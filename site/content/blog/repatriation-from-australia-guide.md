...
1. **Death certificate.** Issued by the state Registry of Births, Deaths and Marriages. Requires a medical certificate of cause of death from the treating doctor or coroner's pathologist.

2. **Coroner's involvement.** Any death that is sudden, unexpected, violent, or where the cause is unknown is referred to the state coroner. The coroner may order a post-mortem. Post-mortems in Australian hospitals are generally conducted within a few days, but in busy metro areas or where specialist pathology is needed, it can be longer.

3. **Embalming certificate.** Required for export. The embalming must be performed to a standard acceptable to the airline. Australian funeral directors handling international work will know the requirements.

4. **Burial transit permit.** Issued by the state health authority. Required for export of human remains from Australia. This is the key export document.

5. **British Consular involvement.** The British High Commission in Canberra and the consulates in Sydney, Melbourne, and Perth can register the death and provide consular support. They are not required for documentation, but they can help.
